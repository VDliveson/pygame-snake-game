...
class MAIN:
    ...
    def draw_score(self):
        ...
        score_surface = game_font.render(score_text, True, (224, 2, 43))
        ...
        pygame.draw.rect(screen, (44, 181, 29), bg_rect)
        screen.blit(score_surface, score_rect)
        screen.blit(apple, apple_rect)
        pygame.draw.rect(screen, (224, 2, 43), bg_rect, 3)
...
class Snake:
    ...
    def draw_snake(self):
        ...
        for index, block in enumerate(self.body):
            ...
            # Check direction of the snake movement
            if(index == 0):
...
game_font = pygame.font.Font('Fonts/YanoneKaffeesatz-SemiBold.ttf', 25)
main_game = MAIN()
fruit = Fruit()
snake = Snake()
